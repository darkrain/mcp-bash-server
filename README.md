...
wget https://github.com/darkrain/mcp-bash-server/releases/download/v1.0.6/mcp-bash-server_1.0.6_amd64.deb
...
|-------------|----------|-----------|
| amd64 | `mcp-bash-server_amd64` | `mcp-bash-server_1.0.6_amd64.deb` |
| arm64 | `mcp-bash-server_arm64` | `mcp-bash-server_1.0.6_arm64.deb` |
